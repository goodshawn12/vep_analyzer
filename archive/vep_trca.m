...
% define parameters
CH = [12, 17:21, 24:26]; % 1:size(epochedEEG{1,1,1,1},1); %[5,10:14,18:20]; %  %[5,10:14,18:20]; % {[12,19], [12,18:20], [5,10:14,18:20], [5,9:15,17:21,24:26], [1:15,17:21,24:26], [1:32]};
data_len_list = [0.2:0.2:3]; % sec
data_offset = 0.2;   % sec
