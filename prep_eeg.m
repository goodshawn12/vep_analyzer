...
%% extract EEG epoch
epochWindow = [-1, 3.2];   % define time window for EEG epoch (in sec)
numTrial = 10;
...
stimList = {'1','2','3','4'}; %,'5'};   % stimulation pattern: 1: HF-MSEQ, 2: LF-MSEQ, 3:LF-SSVEP, 4:HF-SSVEP, 5: IMG
contList = {'2','8','16'};      % contrast level: +- 2, 8, 16
